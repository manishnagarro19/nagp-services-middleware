...
NOTIFICATION_2_QUEUE_NAME = "nagp.order.queue.notification1"
...
logging_config = {
    ...
    "handlers": {
        "notification-service-log": {
            ...
            "filename": os.path.join(LOG_DIR, "notification_1_service.log"),
            "formatter": "json",
    ...
    "loggers": {
        "notification-service": {
            "handlers": ["default", "notification-service-log"],
            "level": LOG_LEVEL,
            "propagate": True,
        },
    },
